...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function initializeAnimations() {
        ...
        function initTypewriter() {
            ...
            const phrases = [
                "Web Security & Network Penetration Testing",
                "Vulnerability Assessment & Exploitation",
                "SOC Monitoring & Incident Analysis",
                "Malware Analysis & Threat Detection Strategies",
                "Protecting Your Offensive & Defensive Cybersecurity"
            ];
